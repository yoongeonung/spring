package yoongeonung.springmvc.basic.requestmapping;
...
public class MappingController {
  ...
  public String mappingPathV1(@PathVariable("uesrId") String userId) {
   ...
   * consumes="application/*" consumes="*\/*" MediaType.APPLICATION_JSON_VALUE(spring)
   */
